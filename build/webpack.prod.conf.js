...
const APP_FILE_URL = get_env('APP_FILE_URL', 'http://ykm_file_web.s4.psd1412.com/'); //api的请求地址
const APP_SCOKET_URL = get_env('APP_SCOKET_URL', 'ws://192.168.1.4:34504/'); //ws的地址
